...
class HoldingResponse(BaseModel):
    ...
    milestone_contribution_daily: Optional[Decimal] = None
...
class ScenarioResponse(BaseModel):
    ...
    days_delta:           int    # vs current projection — positive = better
    required_monthly:     Decimal
...
class AlertActionRequest(BaseModel):
    action: str     # ACTED / IGNORED / WATCHING
...
class StoryCard(BaseModel):
    type:    str    # POSITIVE / WATCH / SIP / ALERT
    text:    str
...
class HomeDashboard(BaseModel):
    ...
    portfolio_health:     str          # HEALTHY / ATTENTION / ACTION_NEEDED
    total_value:          Decimal
    day_change:           Decimal
